...
We now have a bag of parser pieces; next we assemble them into a full grammar for regex notation itself, in [Parsing Pattern Syntax](./pattern-syntax.md).
