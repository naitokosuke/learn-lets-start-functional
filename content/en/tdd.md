...
The package file, `tests/tests.ipkg`, as promised in the [setup chapter](./setup.md):
...
Time for the first real red: in [A Regex Is Data](./regex-as-data.md), the specs demand six constructors that do not exist yet, and the compiler obliges with a satisfying refusal.
