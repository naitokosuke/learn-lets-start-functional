...
- Russ Cox, **"Regular Expression Matching Can Be Simple And Fast"** and its sequels, at [swtch.com/~rsc/regexp](https://swtch.com/~rsc/regexp/). The essays that made linear-time matching a cause; our benchmark's `(a?){n}a{n}` is his.
