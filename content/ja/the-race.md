...
エンジンは速く、肝心なところは証明済みで、自前のベンチマークに鍛えられました。今度はこれで何かを*作る*番です:[総仕上げ:レキサ](./lexer.md)。
